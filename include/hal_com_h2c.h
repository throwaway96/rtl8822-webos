...
#define SET_NETBIOS_FLAGS(__pHeader, __Value)			WriteLE2Byte(((u8 *)(__pHeader)) + 2, __Value)
#define SET_NETBIOS_ANSWER(__pHeader, __Value)				WriteLE2Byte(((u8 *)(__pHeader)) + 6, __Value)
#define SET_NETBIOS_NAME(__pHeader, __Value)			cpNetBiosName(((u8 *)(__pHeader)) + 12, __Value)
#define SET_NETBIOS_TYPE(__pHeader, __Value)					WriteLE2Byte(((u8 *)(__pHeader)) + 46, __Value)
#define SET_NETBIOS_CLASS(__pHeader, __Value)			WriteLE2Byte(((u8 *)(__pHeader)) + 48, __Value)
#define SET_NETBIOS_TTL(__pHeader, __Value)			WriteLE4Byte(((u8 *)(__pHeader)) + 50, __Value)
#define SET_NETBIOS_LEN(__pHeader, __Value)			WriteLE2Byte(((u8 *)(__pHeader)) + 54, __Value)
#define SET_NETBIOS_IP_ADDR(__pHeader, __Value)			cpIpAddr(((u8 *)(__pHeader)) + 58, __Value)

#define SET_SNMP_COMMUNITY_NAME_LEN(__pHeader, __Value)			WriteLE1Byte(((u8 *)(__pHeader)) + 6, __Value)
#define SET_SNMP_DEVICE_STATUS(__pHeader, __Value)			WriteLE1Byte(((u8 *)(__pHeader)) + 16, __Value)
#define SET_SNMP_PRINTER_STATUS(__pHeader, __Value)			WriteLE1Byte(((u8 *)(__pHeader)) + 16, __Value)
#define SET_SNMP_ERROR_STATUS(__pHeader, __Value)			WriteLE2Byte(((u8 *)(__pHeader)) + 16, __Value)
#define SET_SNMP_DISPLAY_STRING_LEN(__pHeader, __Value)		WriteLE1Byte(((u8 *)(__pHeader)) + 12, __Value)
#define SET_SNMP_OBJECT_ID_LEN(__pHeader, __Value)          WriteLE1Byte(((u8 *)(__pHeader)) + 12, __Value)
#define SET_SNMP_OBJECT_NAME_LEN(__pHeader, __Value)		WriteLE1Byte(((u8 *)(__pHeader)) + 18, __Value)
#define SET_SNMP_SLEEP_STATUS(__pHeader, __Value)			WriteLE2Byte(((u8 *)(__pHeader)) + 22, __Value)

#define SET_MDNS_HDR_FLAG(__pHeader, __Value)		WriteLE1Byte(((u8 *)(__pHeader)) + 2, __Value)

#define SET_LLMNR_FLAG(__pHeader, __Value)		WriteLE1Byte(((u8 *)(__pHeader)) + 2, __Value)
#define SET_LLMNR_DATA_LEN(__pHeader, __Value)		WriteLE1Byte(((u8 *)(__pHeader)), __Value)
#define SET_LLMNR_CLASS(__pHeader, data_len, __Value)	WriteLE1Byte(((u8 *)(__pHeader) + data_len + 5), __Value)
#define SET_LLMNR_TTL(__pHeader, data_len, __Value)	WriteLE4Byte(((u8 *)(__pHeader) + data_len + 6), __Value)
...
#define SET_H2CCMD_WAR_CFG_NS_RSP_EN(__pH2CCmd, __Value)        SET_BITS_TO_LE_1BYTE(__pH2CCmd, 2, 1, __Value)
#define SET_H2CCMD_WAR_CFG_ICMPV4_RSP_EN(__pH2CCmd, __Value)    SET_BITS_TO_LE_1BYTE(__pH2CCmd, 3, 1, __Value)
#define SET_H2CCMD_WAR_CFG_ICMPV6_RSP_EN(__pH2CCmd, __Value)    SET_BITS_TO_LE_1BYTE(__pH2CCmd, 4, 1, __Value)
#define SET_H2CCMD_WAR_CFG_NB_RSP_EN(__pH2CCmd, __Value)        SET_BITS_TO_LE_1BYTE(__pH2CCmd, 5, 1, __Value)
#define SET_H2CCMD_WAR_CFG_LLMNRV4_RSP_EN(__pH2CCmd, __Value)   SET_BITS_TO_LE_1BYTE(__pH2CCmd, 6, 1, __Value)
#define SET_H2CCMD_WAR_CFG_LLMNRV6_RSP_EN(__pH2CCmd, __Value)   SET_BITS_TO_LE_1BYTE(__pH2CCmd, 7, 1, __Value)
#define SET_H2CCMD_WAR_CFG_SNMPV4_RSP_EN(__pH2CCmd, __Value)    SET_BITS_TO_LE_1BYTE((__pH2CCmd)+1, 0, 1, __Value)
#define SET_H2CCMD_WAR_CFG_SNMPV6_RSP_EN(__pH2CCmd, __Value)    SET_BITS_TO_LE_1BYTE((__pH2CCmd)+1, 1, 1, __Value)
#define SET_H2CCMD_WAR_CFG_SNMPV4_WAKE_EN(__pH2CCmd, __Value)   SET_BITS_TO_LE_1BYTE((__pH2CCmd)+1, 2, 1, __Value)
#define SET_H2CCMD_WAR_CFG_SNMPV6_WAKE_EN(__pH2CCmd, __Value)   SET_BITS_TO_LE_1BYTE((__pH2CCmd)+1, 3, 1, __Value)
#define SET_H2CCMD_WAR_CFG_SSDPV4_WAKE_EN(__pH2CCmd, __Value)   SET_BITS_TO_LE_1BYTE((__pH2CCmd)+1, 4, 1, __Value)
#define SET_H2CCMD_WAR_CFG_SSDPV6_WAKE_EN(__pH2CCmd, __Value)   SET_BITS_TO_LE_1BYTE((__pH2CCmd)+1, 5, 1, __Value)
#define SET_H2CCMD_WAR_CFG_WSDV4_WAKE_EN(__pH2CCmd, __Value)    SET_BITS_TO_LE_1BYTE((__pH2CCmd)+1, 6, 1, __Value)
#define SET_H2CCMD_WAR_CFG_WSDV6_WAKE_EN(__pH2CCmd, __Value)    SET_BITS_TO_LE_1BYTE((__pH2CCmd)+1, 7, 1, __Value)
#define SET_H2CCMD_WAR_CFG_SLPV4_WAKE_EN(__pH2CCmd, __Value)    SET_BITS_TO_LE_1BYTE((__pH2CCmd)+2, 0, 1, __Value)
#define SET_H2CCMD_WAR_CFG_SLPV6_WAKE_EN(__pH2CCmd, __Value)    SET_BITS_TO_LE_1BYTE((__pH2CCmd)+2, 1, 1, __Value)
...
#define SET_H2CCMD_WAR_CFG_MAC_WAKE_EN(__pH2CCmd, __Value)      SET_BITS_TO_LE_1BYTE((__pH2CCmd)+2, 4, 1, __Value)
#define SET_H2CCMD_WAR_CFG_LLTD_WAKE_EN(__pH2CCmd, __Value)      SET_BITS_TO_LE_1BYTE((__pH2CCmd)+2, 5, 1, __Value)
...
#define SET_H2CCMD_WAROFLD_RSVDPAGE1_LOC_ICMP_PARM(__pH2CCmd, __Value)  SET_BITS_TO_LE_1BYTE((__pH2CCmd), 0, 8, __Value)
#define SET_H2CCMD_WAROFLD_RSVDPAGE1_LOC_ICMPV4_RSP(__pH2CCmd, __Value) SET_BITS_TO_LE_1BYTE((__pH2CCmd)+1, 0, 8, __Value)
#define SET_H2CCMD_WAROFLD_RSVDPAGE1_LOC_ICMPV6_RSP(__pH2CCmd, __Value) SET_BITS_TO_LE_1BYTE((__pH2CCmd)+2, 0, 8, __Value)
#define SET_H2CCMD_WAROFLD_RSVDPAGE1_LOC_ICMPNS_RSP(__pH2CCmd, __Value) SET_BITS_TO_LE_1BYTE((__pH2CCmd)+3, 0, 8, __Value)
#define SET_H2CCMD_WAROFLD_RSVDPAGE1_LOC_NETBIOS_RSP(__pH2CCmd, __Value) SET_BITS_TO_LE_1BYTE((__pH2CCmd)+4, 0, 8, __Value)
#define SET_H2CCMD_WAROFLD_RSVDPAGE1_LOC_SNMP_INFO(__pH2CCmd, __Value) SET_BITS_TO_LE_1BYTE((__pH2CCmd)+5, 0, 8, __Value)
