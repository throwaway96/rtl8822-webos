...
#if defined(CONFIG_SEL_P2P_IFACE) && (CONFIG_SEL_P2P_IFACE > 0) && (CONFIG_SEL_P2P_IFACE < CONFIG_IFACE_NUMBER)
#define dvobj_get_p2p_adapter(dvobj) ((dvobj)->padapters[CONFIG_SEL_P2P_IFACE])
#else
#define dvobj_get_p2p_adapter(dvobj) ((dvobj)->padapters[IFACE_ID0])
#endif
...
#ifdef LGE_PRIVATE
	int rtw_lge_load_setting(_adapter *padapter, char *pathi, int mode, u8 *entry);
#endif
