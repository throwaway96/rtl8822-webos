#========================================
# How to compile the wifidrv-rt8822
#========================================
...
2) Download rtk_8822_wifi_driver.tar.gz on your working directory.
-----------------------------------------
3) tar xzf rtk_8822_wifi_driver.tar.gz
4) cp starfish-sdk-x86_64-aarch64-toolchain-7.0.0.sh ./rtk_8822_wifi_driver
5) cd rtk_8822_wifi_driver
...
9) Confirm 88x2cu.ko file in wifidrv-rt8822
