...
const struct rtw_proc_hdl adapter_proc_hdls[] = {
	...
	* 	RTW_PROC_HDL_SSEQ("rssi_disp",proc_get_rssi_disp, proc_set_rssi_disp), */
	...
	RTW_PROC_HDL_SSEQ("offload_ipv4_addr", proc_get_offload_ipv4_addr, proc_set_offload_ipv4_addr),
	RTW_PROC_HDL_SSEQ("offload_ipv6_addr", proc_get_offload_ipv6_addr, proc_set_offload_ipv6_addr),
#ifdef CONFIG_OFFLOAD_NETBIOS
	RTW_PROC_HDL_SSEQ("offload_netbios_name", proc_get_offload_netbios_name, proc_set_offload_netbios_name),
#endif /* CONFIG_OFFLOAD_NETBIOS */
#if defined(CONFIG_OFFLOAD_LLMNR_V4) || defined(CONFIG_OFFLOAD_LLMNR_V6)
	RTW_PROC_HDL_SSEQ("offload_llmnr_name", proc_get_offload_llmnr_name, proc_set_offload_llmnr_name),
#endif /* CONFIG_OFFLOAD_LLMNR_V4 || CONFIG_OFFLOAD_LLMNR_V6 */
#if defined(CONFIG_OFFLOAD_SNMP_V4) || defined(CONFIG_OFFLOAD_SNMP_V6)
	RTW_PROC_HDL_SSEQ("offload_snmp_community_name", proc_get_offload_snmp_community_name, proc_set_offload_snmp_community_name),
	RTW_PROC_HDL_SSEQ("offload_snmp_device_status", proc_get_offload_snmp_device_status, proc_set_offload_snmp_device_status),
	RTW_PROC_HDL_SSEQ("offload_snmp_printer_status", proc_get_offload_snmp_printer_status, proc_set_offload_snmp_printer_status),
	RTW_PROC_HDL_SSEQ("offload_snmp_error_status", proc_get_offload_snmp_error_status, proc_set_offload_snmp_error_status),
	RTW_PROC_HDL_SSEQ("offload_snmp_display_string", proc_get_offload_snmp_display_string, proc_set_offload_snmp_display_string),
	RTW_PROC_HDL_SSEQ("offload_snmp_enterprise_id", proc_get_offload_snmp_enterprise_id, proc_set_offload_snmp_enterprise_id),
	RTW_PROC_HDL_SSEQ("offload_snmp_object_id", proc_get_offload_snmp_object_id, proc_set_offload_snmp_object_id),
	RTW_PROC_HDL_SSEQ("offload_snmp_object_name", proc_get_offload_snmp_object_name, proc_set_offload_snmp_object_name),
	RTW_PROC_HDL_SSEQ("offload_snmp_sleep_status", proc_get_offload_snmp_sleep_status, proc_set_offload_snmp_sleep_status),
#endif /* CONFIG_OFFLOAD_SNMP_V4 || CONFIG_OFFLOAD_SNMP_V6 */
	RTW_PROC_HDL_SSEQ("offload_mac_addr", proc_get_offload_mac_addr, proc_set_offload_mac_addr),
#ifdef CONFIG_WAKE_PATTERN_EN  
	RTW_PROC_HDL_SSEQ("wow_wake_pattern_info", proc_get_wake_pattern_info, proc_set_wake_pattern_info),
#endif
	...
	RTW_PROC_HDL_SSEQ("offload_ssdp_pattern", proc_get_offload_ssdp_pattern, proc_set_offload_ssdp_pattern),
	...
	RTW_PROC_HDL_SSEQ("offload_wsd_pattern", proc_get_offload_wsd_pattern, proc_set_offload_wsd_pattern),
	...
	RTW_PROC_HDL_SSEQ("offload_slp_pattern", proc_get_offload_slp_pattern, proc_set_offload_slp_pattern),
