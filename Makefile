...
EXTRA_CFLAGS += -DCONFIG_RTW_DYNAMIC_NDEV=1
...
#EXTRA_CFLAGS += -DCONFIG_WAR_OFFLOAD -DCONFIG_OFFLOAD_MDNS_V4 -DCONFIG_OFFLOAD_MDNS_V6
...
$(info PLATFORM is not match)
STOP_BUILD=y
else ifeq ($(CROSS_COMPILE),)
$(info CROSS_COMPILE is empty)
STOP_BUILD=y
else ifeq ($(LINUX_SRC),)
$(info LINUX_SRC is empty)
STOP_BUILD=y
endif

ifeq ($(STOP_BUILD),y)
$(error "Please define PLATEFORM/CROSS_COMPILE/KSRC")
endif
